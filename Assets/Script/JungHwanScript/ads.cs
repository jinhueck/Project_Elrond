...
public class ads : MonoBehaviour {
    ...
    void Start() {
        ...
        ad.OnAdLoaded += OnAdLoaded; // 광고요청이 성공적으로 로드되면 호출됩니다.
        ad.OnAdFailedToLoad += OnAdFailedToLoad; //광고요청을 로드하지 못했을 때 호출됩니다.
        ad.OnAdOpening += OnAdOpening; //광고가 표시될 때 호출됩니다.
        ad.OnAdStarted += OnAdStarted; //광고가 재생되기 시작하면 호출됩니다.
        ad.OnAdRewarded += OnAdRewarded; //사용자가 비디오 시청을 통해 보상을 받을 때 호출됩니다.
        ad.OnAdClosed += OnAdClosed; //광고가 닫힐 때 호출됩니다.
        ad.OnAdLeavingApplication += OnAdLeavingApplication; //광고클릭으로 인해 사용자가 애플리케이션을 종료한 경우 호출됩니다.
